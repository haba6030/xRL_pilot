...
def load_multiclass_discriminator(model_path='models/multiclass_discriminator_opponent.pt'):
...
def visualize_results(results_df, stats):
    ...
    # Save
    output_path = 'figures/human_h_opponent_results.png'
...
def save_results(results_df, output_csv='human_h_opponent_estimates.csv'):
    """Save results to CSV"""
